...
# prints what you wrote two times: print the contents once by reading in 
# the entire file, and once by storing the lines in a list and then 
...
lines = Path("Part 10/textfile1.txt").split
