...
#  a country name. The function should return a single string of the form
...
# Write a function called test_city_country() to verify that calling your function with 
# values such as 'santiago' and 'chile' results in the correct string. 
