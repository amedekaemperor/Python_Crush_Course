...
foods = ('sausage rools', 'chicken wings', 'vegetable sausage', 'meat balls')
...
foods = ('sausage rools', 'chicken wings', 'vegetable sausage', 'meat balls', 'chicken scones', 'halloumi fries')
for food in foods:
    print(food)
